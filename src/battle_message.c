...
static const u8 sText_WildPkmnAppeared[] = _("The Gauntlet Begins!\p");
...
static const u8 sText_GauntletTrainerName[] = _("Gauntlet");
static const u8 sText_Trainer1SentOutPkmn[] = _("The Gauntlet Continues!");
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PLAYERWHITEOUT]                       = COMPOUND_STRING("You have failed the Gauntlet!\p"),
...
static const u8 *BattleStringGetOpponentNameByTrainerId(u16 trainerId, u8 *text, u8 multiplayerId, enum BattlerId battler)
{
    ...
    else if (gBattleTypeFlags & BATTLE_TYPE_GAUNTLET)
    {
        toCpy = sText_GauntletTrainerName;
    }
    else
    {
